...
def find_meridian_time(ms: Path, integration_time: u.Quantity = 15 * u.min) -> Tuple[Time, Time]:
...
def cli():
    ...
    parser.add_argument("--integration_time", type=float, default=15, help="Integration time in minutes")
    parser.add_argument("--field_prefix", type=str, default="EMU", help="Field name prefix")
